 ...
 * the event's {@code published_at} set despite the message never truly landing. Since nothing in
 * V2 consumes {@code hold.*} events yet, this gap has no functional impact today; if a future
 * version adds a real consumer for these events, revisit whether publisher-confirms are needed
 * then.
 */
@Component
